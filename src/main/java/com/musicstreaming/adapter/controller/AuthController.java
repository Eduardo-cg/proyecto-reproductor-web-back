...
import com.musicstreaming.adapter.dto.LoginRequest;
...
import com.musicstreaming.domain.service.AuthService;
...
public class AuthController {
    ...
    public Mono<ResponseEntity<UserResponse>> getCurrentUser(@AuthenticationPrincipal UserDetails userDetails) {
        ...
        Long userId = Long.parseLong(((com.musicstreaming.adapter.security.UserPrincipal) userDetails).getId().toString());
